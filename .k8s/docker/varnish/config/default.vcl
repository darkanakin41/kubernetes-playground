...
sub vcl_recv {
  ...
  if (req.url ~ "\.(jpeg|jpg|png|gif|ico|svg|swf|js|css|txt|eot|woff|ttf|htc)(\?.*|)$") {
...
sub vcl_backend_response {
  ...
  if (bereq.url ~ "(?i)\.(jpeg|jpg|png|gif|svg|ico|swf|js|css|txt|eot|woff|ttf|htc|mp3|m4a|mp4|m4v|mov|mpeg|mpg|avi|divx|ogg|ogv|wma|pdf|tar|gz|gzip|bz2|asc|dat|doc|xls|ppt|tgz|csv)(\?.*|)$") {
